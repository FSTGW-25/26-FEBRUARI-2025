...
<body>
  <div class="title-box">19 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 10.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen-Oh My!.mp3');
    ...
    const fullMessage = `""Kadang hidup datang dengan kejutan-kejutan yang tak terduga 🌻. Semua yang kita jalani bisa terasa membingungkan, tetapi percayalah bahwa setiap hal yang kita lalui memiliki tujuan 🌈. Meskipun sering kali tak sesuai dengan harapan, ada pelajaran berharga yang akan kita temukan sepanjang perjalanan🌼. Jangan menyerah, tetap semangat! 🤍"`;
